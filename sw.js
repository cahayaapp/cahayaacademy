const CACHE='belajarislam-v6.4.6-shell';
const ASSETS=[
  './','./index.html','./assets/css/styles.css?v=646','./assets/img/logo-icon.svg?v=646','./assets/img/favicon.ico?v=646',
  './assets/img/icon-32.png?v=646','./assets/img/icon-64.png?v=646','./assets/img/icon-180.png?v=646','./assets/img/icon-192.png?v=646',
  './assets/img/icon-maskable-192.png?v=646','./assets/img/icon-512.png?v=646','./assets/img/icon-maskable-512.png?v=646','./manifest.webmanifest?v=646'
];
